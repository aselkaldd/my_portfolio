...
// import { ReactComponent as Phone } from '../img/telephone-phone-svgrepo-com.svg';
...
export default function Contacts() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_1l1tq35', 'template_zeknbsk', formRef.current, { publicKey: 'Ydf4alLpNUGE6F5JSf' })
      .then((result) => {
        setSuccess(true);
      }, (error) => {
        setError(true);
    ...
    <motion.div ref={ref} className="contact" variants={variants} initial='initial' whileInView='animate' >
      ...
      <motion.div className='textContainer' variants={variants}>
        ...
        <motion.div className='item' variants={variants}>
          <h2>Mail</h2>
          <span>kaldarbaeva.asel@gmail.com</span>
        </motion.div>

        <motion.div className='item' variants={variants}>
          <h2>Phone</h2>
          <span>+49 178 908 976 1</span>
        </motion.div>
      ...
      <div className='formContainer'>
        ...
        <motion.div className='phoneSvg'
          ...
          <motion.svg height="450px" width="450px" version="1.1" id="Layer_1"
            ...
            <g>
              <g>
                <motion.path
                  ...
                  initial={{ pathLength: 0 }}
                  animate={isInView && { pathLength: 1 }}
                  transition={{ duration: 3 }} d="M256.004,200.189c-48.428,0-87.828,39.399-87.828,87.828c0,48.428,39.4,87.827,87.828,87.827
			c48.428,0,87.828-39.399,87.828-87.827C343.831,239.589,304.432,200.189,256.004,200.189z M256.004,358.447
			c-38.835,0-70.431-31.595-70.431-70.43c0-38.835,31.595-70.431,70.431-70.431c38.836,0,70.431,31.595,70.431,70.431
			C326.434,326.853,294.839,358.447,256.004,358.447z"/>
              </g>
